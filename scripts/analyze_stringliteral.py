...
PLAYER_KEYWORDS = [
    "you", "your", "skill", "damage", "craft", "combat", "xp", "level",
    "buff", "vendor", "shop", "favor", "heal", "armor", "weapon", "quest",
    "train", "death", "dying", "curse", "loot", "corpse", "item", "recipe",
    "npc", "enemy", "monster", "player", "attack", "defense", "stamina",
    "power", "mana", "health", "crafting", "gathering", "mining", "forestry",
    "transmutation", "sword", "staff", "dagger", "club", "hammer", "axe",
    "bow", "crossbow", "shield", "potion", "elixir", "food", "drink",
    "ingredient", "material", "equip", "wear", "slot", "inventory", "bag",
    "backpack", "storage", "vault", "chest", "vendor", "buy", "sell", "trade",
    "auction", "consignment", "coin", "gold", "token", "point", "gift",
    "favor", "reputation", "standing", "title", "achievement", "medal",
    "trophy", "housing", "home", "deed", "plot", "decorate", "furniture",
    "pet", "mount", "costume", "emote", "dance", "music", "instrument",
    "gym", "sport", "golf", "game", "puzzle", "race", "event", "holiday",
    "festival", "season", "daily", "weekly", "monthly", "timer", "cooldown",
    "cooldown", "recovery", "regeneration", "resistance", "weakness",
    "vulnerability", "immunity", "absorb", "reflect", "block", "parry",
    "dodge", "evade", "critical", "glance", "hit", "miss", "stun", "slow",
    "snare", "root", "knockback", "knockdown", "pull", "push", "teleport",
    "portal", "travel", "fast travel", "waypoint", "bind", "respawn",
    "corpse run", "spirit", "ghost", "revive", "resurrect", "death",
    "penalty", "debt", "repair", "durability", "enchant", "augment",
    "infuse", "transmute", "salvage", "disenchant", "recycle", "upgrade",
    "downgrade", "reroll", "reforge", "reroll", "polish", "dye", "paint",
    "skin", "appearance", "glamour", "style", "fashion", "cosmetic",
    "visual", "particle", "effect", "animation", "sound", "music", "audio",
    "volume", "master", "brightness", "gamma", "resolution", "window",
    "fullscreen", "vsync", "fps", "frame", "rate", "quality", "detail",
    "shadow", "light", "fog", "ambient", "occlusion", "bloom", "hdr",
    "antialiasing", "filter", "texture", "shader", "model", "mesh",
    "terrain", "vegetation", "water", "sky", "weather", "time", "day",
    "night", "cycle", "season", "winter", "spring", "summer", "fall",
    "dungeon", "raid", "trial", "instance", "scenario", "mission",
    "objective", "goal", "task", "errand", "favor", "quest", "story",
    "lore", "history", "legend", "myth", "faction", "clan", "guild",
    "group", "party", "solo", "multiplayer", "co-op", "pvp", "duel",
    "arena", "battleground", "war", "conflict", "truce", "peace",
    "alliance", "enemy", "hostile", "aggressive", "passive", "neutral",
    "friendly", "ally", "companion", "follower", "minion", "summon",
    "fairy", "race", "class", "archetype", "role", "build", "spec",
    "talent", "passive", "active", "ability", "power", "move", "spell",
    "chant", "incantation", "prayer", "ritual", "technique", "form",
    "stance", "mode", "state", "transform", "shape", "shift", "rage",
]
...
# ── stop words ─────────────────────────────────────────────────────────────
STOP_KEYWORDS = [
    "please report at", "mesh baker", "texture packer", "submesh",
    "assetbundle", "vivox", "compute shader", "shader", "depth buffer",
    "render texture", "gpu", "graphics api", "render graph", "shader graph",
    "material", "prefab", "animator", "ik target", "bone", "skinned mesh",
]
...
def classify_topic(val: str) -> str:
    ...
    if any(w in low for w in ["shop", "vendor", "sell", "buy", "price", "purchase", "consignment",
                               "customer", "item listing", "stack", "reserve"]):
    ...
    if any(w in low for w in ["armor", "health", "power", "regeneration", "food", "hunger",
                               "thirst", "metabolism", "naked"]):
    ...
    if any(w in low for w in ["settings", "option", "enable", "disable", "toggle",
                               "show", "display", "graphics", "quality", "font"]):
        topics.append("settings--ui")
    if any(w in low for w in ["chat", "message", "whisper", "tell", "say", "shout",
                               "emote", "spoiler", "bracket"]):
        topics.append("communication--chat")
    if any(w in low for w in ["party", "group", "friend", "invite", "player",
                               "other player", "nearby", "global"]):
    ...
    if any(w in low for w in ["damage number", "combat log", "floaty", "healing number",
                               "particle", "effect"]):
    ...
    if any(w in low for w in ["item", "equip", "inventory", "bag", "backpack",
                               "container", "stack", "drag", "drop"]):
...
def main():
    ...
    with open(DOT_PATH, "w", encoding="utf-8") as f:
        ...
        f.write(f"Generated by `scripts/analyze_stringliteral.py`\n")
